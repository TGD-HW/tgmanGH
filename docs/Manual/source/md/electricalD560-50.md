...
- Odstraňte vhodnou délku vnější izolace motorového kabelu tak, aby bylo možné pohodlně připevnit vnější stínění kabelu do připravené svorky na krytu servozesilovače.
...
- Připravené silové vodiče osazené dutinkami vložte do svorek pro připojení motoru 1 resp. 2.
- Vložte připravený kabel s vnějším opletem do stínicí svorky na krytu.
