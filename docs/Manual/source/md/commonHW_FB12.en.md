...
For this sensor, it is recommended to use an additional data communication filter with a ferrite ring. To do so, make one turn through the ferrite ring with all four wires:
