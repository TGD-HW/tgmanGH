##3D náhled
![TGZ-S-48-100/250-UNIR-RI MotSide](../img/MotSide.webp){: style="width:70%;" }   
<br>
<br>
![TGZ-S-48-100/250-UNIR-RI IO](../img/IOside.webp){: style="width:70%;" }   

##Blokové schéma s připojením hlavních rozhraní
![TGZ-S-48-100/250-UNIR-RI dia](../img/blokDiagram.png){: style="width:70%;" }
...
Na řídicí desce jsou čtyři pozice (R300-R303) pro SMD rezistory 0R/0603, které mohou být použity k nahrazení externího propojení FBSEL (piny 5-7 a 6-8 konektoru FB1 a FB2).
