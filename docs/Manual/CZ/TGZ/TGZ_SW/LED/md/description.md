...
| Chyba průmyslové sběrnice  | 0x00020000                           | 17                      | Nedorazila platná data po průmyslové sběrnici ve stanoveném čase.<br>Příčina 1: Závada kabeláže.<br>Řešení 1: Překontrolujte kabeláž, konektory.<br>Příčina 2: Závada na jiném zařízení na sběrnici.<br>Řešení 2: Diagnostikujte zda není závada na jiném zařízení na sběrnici, případně ho vyřaďte.<br>Příčina 3: Problém řídícího systému.<br>Řešení 3: Ověřte parametry a nastavení systému, případně kontaktujte dodavatele řídícího systému. |
| Chyba regulace proudu      | 0x00080000                           | 19                      | Detekována odchylka skutečného a žádaného proudu<br>Příčina 1: Závada kabeláže.<br>Řešení 1: Překontrolujte kabeláž, konektory.<br>Příčina 2: Nevhodné nastavení proudového regulátoru nebo jiná chyba v parametrech<br>Řešení 2: Zkontrolujte správnost parametrů proudového regulátoru.<br>Příčina 3: HW porucha měniče TGZ<br>Řešení 3: Kontaktujte servisní oddělení dodavatele servozesilovače. |
| Nouzové zastavení          | 0x00100000                           | 20                      | Bylo aktivováno nouzové zastavení viz. [Nouzové zabrždění](../../../../SW/REG/md/ESTOP.md).|
| Proudové přetížení         | 0x00200000                           | 21                      | Proudové přetížení motoru (zkrat).<br>Příčina 1: Zkrat na motoru, kabeláži nebo v konektorech.<br>Řešení 1: Prověřte jednotlivé komponenty a odstraňte zkrat.<br>Příčina 2: Nízká hodnota parametru D-Ierr_level.<br>Řešení 2: Nastavte hodnotu dle parametrů motoru (o 20% vyšší než je maximální proud motoru).<br>Příčina 3: Chybné nastavení proudového regulátoru.<br>Řešení 3: Nastavte proudový regulator dle parametrů motoru.<br>Příčina 4: Závada servozesilovače.<br>Řešení 4: Kontaktujte servisní oddělení. |
| Chyba brzdného odporu      | 0x00400000                           | 22                      | Chyba brzdného odporu (Servozesilovače TGZS).<br>Příčina 1: Špatné zapojení.<br>Řešení 1: Ověřte zapojení dle schématu.<br>Příčina 2: Brzdný odpor je přehřátý nebo poškozený.<br>Řešení 2: Ověřte dimenzování brzdného odporu. |
| Chyba parametrů            | 0x08000000                           | 27                      | Chyba parametrů servozesilovače.<br>Příčina 1: Není vložena SD karta a je požadováno vyčtení parametrů z SD karty.<br>Řešení 1: Ověřte správné vložení SD karty.<br>Příčina 2: Struktura parametrů se změnila např. po přehrátí firmware.<br>Řešení 2: Načtěte parametry ze záložního souboru nebo nastavte ručně a uložte parametry na požadované umístění.<br>Příčina 3: SD karta je poškozena.<br>Řešení 3: Nahraďte kartu kartou podobného typu a uložte na ní parametry ze zálohy.<br>Příčina 4: Nebylo provedeno výchozí uložení parametrů do flash. Je nutné i při využívání SD karty.<br>Řešení 4: Uložte parametry do flash paměti. |
| Podpětí DCbus varování   | -		                            | Lo C.1, C.2                | Napětí meziobvodu je příliš nízké. Varování se zobrazuje i bez Enable.<br>Příčina 1: Napájecí zdroj (DC) není připojen, je v poruše, je vypnutý nebo nemá dostatečný výkon.<br>Řešení 1: Zkontrolujte napájecí zdroj.<br>Příčina 2: Vysoká hodnota parametru D – VoltDCLinkMinErrLim.<br>Řešení 2: Upravte hodnotu D – VoltDCLinkMinErrLim.<br>Příčina 3: Zkrat na meziobvodu.<br>Řešení 3: Kontaktujte dodavatele zařízení (servis). |