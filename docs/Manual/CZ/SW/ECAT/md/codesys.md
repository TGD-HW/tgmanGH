...
<img src="../../../../../source/common/img/codesys1.webp" alt="Codesys img" style="width:70%;">

- V závislosti na použitém typu sběrnice vyberte v položce `UseCANbus` buď `EtherCAT`, nebo `CAN`.

<img src="../../../../../source/common/img/codesys2.webp" alt="Codesys img" style="width:70%;">
...
<img src="../../../../../source/common/img/codesys3.webp" alt="Codesys img" style="width:50%;">

- Zařízení Control Win (soft real-time) je vhodné pro režimy PP a PV.

<img src="../../../../../source/common/img/codesys4.webp" alt="Codesys img" style="width:50%;">
...
<img src="../../../../../source/common/img/codesys5.webp" alt="Codesys img" style="width:50%;">

- Zvolte **Install** a vyberte správný soubor.

<img src="../../../../../source/common/img/codesys6.webp" alt="Codesys img" style="width:50%;">

- Pravým tlačítkem myši klikněte na **Device (CODESYS Control Win V3 x64)** a vyberte možnost **Add device**.

<img src="../../../../../source/common/img/codesys7.webp" alt="Codesys img" style="width:50%;">

- V následujícím dialogu vyberte položku **EtherCAT Master SoftMotion** a klikněte na tlačítko **Add Device**.

<img src="../../../../../source/common/img/codesys8.webp" alt="Codesys img" style="width:50%;">
...
<img src="../../../../../source/common/img/codesys9.webp" alt="Codesys img" style="width:50%;">
...
<img src="../../../../../source/common/img/codesys10.webp" alt="Codesys img" style="width:40%;">

- Přejmenujte přidanou osu na **Drive** pomocí kontextové nabídky **Refactoring**.

<img src="../../../../../source/common/img/codesys11.webp" alt="Codesys img" style="width:60%;">
<img src="../../../../../source/common/img/codesys12.webp" alt="Codesys img" style="width:35%;">

- Spusťte **Control Win PLC** ze systémové lišty Windows.

<img src="../../../../../source/common/img/codesys13.webp" alt="Codesys img" style="width:20%;">
...
<img src="../../../../../source/common/img/codesys14.webp" alt="Codesys img" style="width:90%;">

- Přihlaste se k zařízení pomocí uživatelského jména a hesla.

<img src="../../../../../source/common/img/codesys15.webp" alt="Codesys img" style="width:50%;">

- Po úspěšném přihlášení by měla ikona zařízení svítit zeleně.

<img src="../../../../../source/common/img/codesys16.webp" alt="Codesys img" style="width:50%;">
...
<img src="../../../../../source/common/img/codesys17.webp" alt="Codesys img" style="width:80%;">

- Zaškrtněte políčko **Use LRW instead of LWR/LRD**.

<img src="../../../../../source/common/img/codesys18.webp" alt="Codesys img" style="width:50%;">
...
<img src="../../../../../source/common/img/codesys19.webp" alt="Codesys img" style="width:70%;">

  Skupina **Common** v TGZ_GUI
  
 <img src="../../../../../source/common/img/codesys20.webp" alt="Codesys img" style="width:80%;">

- V okně **TGZ_Drive properties** vyberte kartu **Startup Parameters** a změňte hodnotu objektů SDO `6060 a 6860 z 8 na 1`.

<img src="../../../../../source/common/img/codesys21.webp" alt="Codesys img" style="width:60%;">
...
```
  ...
  <img src="../../../../../source/common/img/codesys22.webp" alt="Codesys img" style="width:50%;">
...
<img src="../../../../../source/common/img/codesys23.webp" alt="Codesys img" style="width:45%;">

- Ponechte výchozí název **Visualization** a klikněte na tlačítko **Add**.

<img src="../../../../../source/common/img/codesys24.webp" alt="Codesys img" style="width:30%;">

- V okně **Visualization Toolbox** vyberte položku SML a poté šablonu VISU_SML_StartupDrive.

<img src="../../../../../source/common/img/codesys25.webp" alt="Codesys img" style="width:20%;">
...
<img src="../../../../../source/common/img/codesys26.webp" alt="Codesys img" style="width:80%;">

- V případě potřeby můžete změnit velikost šablony v okně

<img src="../../../../../source/common/img/codesys27.webp" alt="Codesys img" style="width:80%;">
